...
var encodedData = require('soop').load('adscore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('adscore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('adscore/lib/Address', {
